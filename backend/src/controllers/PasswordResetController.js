...
export const requestPasswordResetController = async (req, res) => {
  ...
  try {
    ...
    logger.error("Error in requestPasswordResetController", { error: error.message, stack: error.stack });
...
export const verifyCodeController = async (req, res) => {
  ...
  try {
    ...
    logger.error("Error in verifyCodeController", { error: error.message, stack: error.stack });
    return res.status(500).json({ message: "Internal server error" });
  }
};
...
export const resetPasswordController = async (req, res) => {
  ...
  try {
    ...
    logger.error("Error in resetPasswordController", { error: error.message, stack: error.stack });
...
export const resendCodeController = async (req, res) => {
  ...
  try {
    ...
    logger.error("Error in resendCodeController", { error: error.message, stack: error.stack });
    return res.status(500).json({ message: "Internal server error" });
  }
};