...
export const subscribeToUser = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Subscribed successfully', subscribed: true, subscription });
    } catch (error) {
...
export const unsubscribeFromUser = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Unsubscribed successfully', subscribed: false, removed: !!removed });
    } catch (error) {
...
export const getSubscriptionStatus = async (req, res) => {
    try {
        ...
        logger.error("Get subscription status error", { error: error.message, stack: error.stack });
...
export const getMySubscriptions = async (req, res) => {
    try {
        ...
        logger.error("Get my subscriptions error", { error: error.message, stack: error.stack });
...
export const getSubscribedFeed = async (req, res) => {
    try {
        ...
        logger.error("Get subscribed feed error", { error: error.message, stack: error.stack });
